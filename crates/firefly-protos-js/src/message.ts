    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 16: {
          ...
          message.getPendingHistoryRequestsResponse = GetPendingHistoryRequestsResponse.decode(reader, reader.uint32());
          continue;
        }
        case 17: {
          if (tag !== 138) {
...
function createBaseDirectBackupChunk(): DirectBackupChunk {
  return { id: "", start: 0n, count: 0, blobPath: "", byteSize: 0n, ciphertextHash: new Uint8Array(0) };
}
...
export const DirectBackupManifest: MessageFns<DirectBackupManifest> = {
  ...
  fromJSON(object: any): DirectBackupManifest {
    return {
      ...
      verifier: isSet(object.verifier) ? bytesFromBase64(object.verifier) : new Uint8Array(0),
      ...
      chunks: globalThis.Array.isArray(object?.chunks)
        ...
        : [],
      authentication: isSet(object.authentication) ? bytesFromBase64(object.authentication) : new Uint8Array(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DirectBackupManifest>, I>>(object: I): DirectBackupManifest {
    ...
    message.verifier = object.verifier ?? new Uint8Array(0);
    message.scheduleDays = object.scheduleDays ?? 0;
    message.chunks = object.chunks?.map((e) => DirectBackupChunk.fromPartial(e)) || [];
    message.authentication = object.authentication ?? new Uint8Array(0);
    return message;
  },
};
...
function createBaseDirectBackupRecord(): DirectBackupRecord {
  return { sourceId: 0n, other: "", sentByOther: false, message: new Uint8Array(0), messageType: 0 };
}
...
function createBaseDirectBackupKeySync(): DirectBackupKeySync {
  return { version: 0, epoch: "", key: new Uint8Array(0), requestKey: false, requestId: "" };
}
